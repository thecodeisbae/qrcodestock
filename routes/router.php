...
switch($_uri)
{
    ...
    case 'submitLoginAjax':
        Route::lead($_uri,$_params,'LoginController','checkLogin',$_method);
        break;
    
    case 'submitRegisterAjax':
        Route::lead($_uri,$_params,'RegisterController','submitRegisterAjax',$_method);
        break;
    ...
    case 'register': 
        if($_method == 'GET') 
            Route::lead($_uri,$_params,'RegisterController','index',$_method);
        if($_method == 'POST') 
            Route::lead($_uri,$_params,'RegisterController','register',$_method);
    break;
}
